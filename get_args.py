...
def get_args():
    ...
    parser.add_argument("--dataset_name", default="ortho", type=str)
    ...
    parser.add_argument("--missing_pattern", default="random", type=str, help="Set the missing pattern.") 
    parser.add_argument("--include_complete", default=False, type=bool)
    # only used in SINGLE missing pattern
    parser.add_argument("--col_to_remove", default=1, type=int)
    ...
    parser.add_argument("--new_num_per_origin", default=21, type=int)
